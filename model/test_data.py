...
r232 = Room(id='r232', connected_to=['cs4'], room_type=RoomType.LaboratoryRoom, pos_x=12, pos_y=0, width=4, height=4)
...
r212 = Room(id='r212', connected_to=['cs3'], room_type=RoomType.LaboratoryRoom, pos_x=10, pos_y=6, width=3, height=3)
r216 = Room(id='r216', connected_to=['cs4'], room_type=RoomType.LaboratoryRoom, pos_x=13, pos_y=6, width=3, height=3)
